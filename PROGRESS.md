...
- [x] COC-01 — Ver los pedidos pendientes por prioridad (FIFO simple por ahora — el forzado por anti-inanición es ADM-04/COC-08, P2; "Mis pedidos en curso" ahora se separa de un acordeón colapsable "Pedidos completados" (líneas todas en listo); falta confirmación del usuario en el navegador)
